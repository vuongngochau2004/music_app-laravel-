    ...
    <div class="QA_section">
      <div class="white_box_tittle list_header">
        ...
        <div class="box_right d-flex lms_block">
          ...
          <div class="add_button ms-3">
            <a href="{{route('artists.create')}}" data-toggle="modal" data-target="#addSongModal" class="btn btn-primary">Add New Singer</a>
          </div>
           <div class="add_button ms-3">
              <a href="{{route('artists.trash')}}" class="btn btn-primary" ><i class="align-middle" data-feather="trash-2"></i> Bin</a>     
          </div>
        </div>
      </div>
          ...
          <table class="table lms_table_active dataTable no-footer dtr-inline" id="DataTables_Table_1">
            <thead>
              <tr>
                ...
                <th scope="col" class="sorting" style="width: 150px;">Name</th>
                <th scope="col" class="sorting" style="width: 170px;">Country</th>
                <th scope="col" class="sorting" style="width: 100px;">Birthday</th>
                ...
                <tr>
                  ...
                  <td>
                    <div class="action_btns d-flex">
                      <a class="nav-icon dropdown-toggle" href="{{route('artists.edit',$item)}}" id="alertsDropdown" >
