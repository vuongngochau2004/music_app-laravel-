                ...
                <tr>
                  ...
                  <td>
                    <div class="action_btns d-flex">
                        <a class="nav-icon dropdown-toggle" href="{{route('artists.restore',$item->id)}}" id="alertsDropdown" >
                            <div class="position-relative">
                              <i class="align-middle" data-feather="rotate-ccw"></i>
                            </div>
                          </a>
                          <a class="nav-icon dropdown-toggle" href="{{route('artists.forceDelete',$item->id)}}" onclick="return confirm('Bạn chắc chưa!')" id="alertsDropdown" >
                            <div class="position-relative">
