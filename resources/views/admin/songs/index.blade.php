    ...
    <div class="QA_section">
      <div class="white_box_tittle list_header">
        ...
        <div class="box_right d-flex lms_block">
          ...
          <div class="add_button ms-3">
            <a href="{{route('songs.create')}}" data-toggle="modal" data-target="#addSongModal" class="btn btn-primary">Add New Song</a>
          </div>
          <div class="add_button ms-3">
              <a href="{{route('songs.trash')}}" class="btn btn-primary" ><i class="align-middle" data-feather="trash-2"></i> Bin</a>     
          </div>
        </div>
      </div>
                ...
                <tr>
                  ...
                  <td>
                    <div class="action_btns d-flex">
                      <a class="nav-icon dropdown-toggle" href="{{route('songs.edit',$item)}}" id="alertsDropdown" >
                        <div class="position-relative">
                          <i class="align-middle" data-feather="edit"></i>
                        </div>
                      </a>
                    <form action="{{route('songs.destroy',$item)}}" method="POST">
                      @csrf
                      @method('DELETE')
